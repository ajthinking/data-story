...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.onGetNodeDescriptions = void 0;
const core_1 = __webpack_require__(8);
const onGetNodeDescriptions = async ({ event, webviewPanel }) => {
...
var jsonEvaluation_1 = __webpack_require__(61);
Object.defineProperty(exports, "jsonEvaluation", ({ enumerable: true, get: function () { return jsonEvaluation_1.jsonEvaluation; } }));
var hjsonEvaluation_1 = __webpack_require__(58);
Object.defineProperty(exports, "hjsonEvaluation", ({ enumerable: true, get: function () { return hjsonEvaluation_1.hjsonEvaluation; } }));
var jsFunctionEvaluation_1 = __webpack_require__(60);
Object.defineProperty(exports, "jsFunctionEvaluation", ({ enumerable: true, get: function () { return jsFunctionEvaluation_1.jsFunctionEvaluation; } }));
var jsExpressionEvaluation_1 = __webpack_require__(59);
Object.defineProperty(exports, "jsExpressionEvaluation", ({ enumerable: true, get: function () { return jsExpressionEvaluation_1.jsExpressionEvaluation; } }));
var numberCast_1 = __webpack_require__(56);
Object.defineProperty(exports, "numberCast", ({ enumerable: true, get: function () { return numberCast_1.numberCast; } }));
var stringCast_1 = __webpack_require__(57);
Object.defineProperty(exports, "stringCast", ({ enumerable: true, get: function () { return stringCast_1.stringCast; } }));
var core_1 = __webpack_require__(133);
Object.defineProperty(exports, "core", ({ enumerable: true, get: function () { return core_1.core; } }));
exports.nodes = __importStar(__webpack_require__(52));
 ...
 */
const nanoid = (0, nanoid_1.customAlphabet)('0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz', 10);
const createDataStoryId = () => nanoid();
exports.createDataStoryId = createDataStoryId;
...
const TreeManager_1 = __webpack_require__(48);
class Application {
    ...
    boot() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const mockDelayPromise = new Promise((resolve) => {
                setTimeout(() => {
                    resolve(1);
                }, 100);
            });
            yield mockDelayPromise;
            this.hasBooted = true;
            return this;
        });
    }
    ...
    descriptions() {
        ...
        const fromNestedNodes = Object.entries(this.registry.nestedNodes).map(([name, diagram]) => {
            return NodeDescriptionFactory_1.NodeDescriptionFactory.fromDiagram(name, diagram);
        });
        return [
            ...fromComputers,
            ...fromNestedNodes
    ...
    getDiagramBuilder() {
        return new DiagramBuilder_1.DiagramBuilder();
    }
    getDiagramBuilderV3() {
        return new DiagramBuilderV3_1.DiagramBuilderV3(Object.values(this.registry.computers));
    }
    getExecutor({ diagram, storage, inputObserverController }) {
        return ExecutorFactory_1.ExecutorFactory.create({
            diagram,
...
class DiagramBuilder {
    ...
    add(config, params = {}, ports) {
        var _a, _b, _c, _d, _e;
        // The computer config might be partial
        // so we are resolving it to a full computer
        const computer = new ComputerFactory_1.ComputerFactory().getInstance(config);
        ...
        const node = {
            ...
            inputs: ((_b = (_a = ports === null || ports === void 0 ? void 0 : ports.inputs) !== null && _a !== void 0 ? _a : computer.inputs) !== null && _b !== void 0 ? _b : []).map(input => {
                return Object.assign(Object.assign({}, input), { id: `${nodeId}.${input.name}` });
            }),
            // The outputs have not yet been assigned ids, to it here
            outputs: ((_d = (_c = ports === null || ports === void 0 ? void 0 : ports.outputs) !== null && _c !== void 0 ? _c : computer.outputs) !== null && _d !== void 0 ? _d : []).map(output => {
                return Object.assign(Object.assign({}, output), { id: `${nodeId}.${output.name}` });
            }),
            // default params
        ...
        for (const [key, value] of Object.entries(params)) {
            ...
            if (!param)
                throw new Error(`Bad param: ${key}. Param not found on ${node.id}`);
            param.value = (0, isStringableParam_1.isStringableParam)(param.type) ? Object.assign(Object.assign({}, ((_e = param.value) !== null && _e !== void 0 ? _e : {})), { value }) : value;
        }
        if (this.aboveDirective) {
            const aboveNode = this.diagram.nodes.find(node => node.id === this.aboveDirective);
            if (!aboveNode)
                throw new Error(`Bad above directive: ${this.aboveDirective}. Node not found`);
            node.position = {
            ...
            if (!belowNode)
                throw new Error(`Bad below directive: ${this.belowDirective}. Node not found`);
            node.position = {
    ...
    addNestedNode(name, diagram, params = {}) {
        var _a;
        ...
        const node = {
            ...
            inputs: diagram.inputNodes().map(inputNode => {
                ...
                const inputName = (0, isStringableParam_1.isStringableParam)(param === null || param === void 0 ? void 0 : param.type) ? (param === null || param === void 0 ? void 0 : param.value).value : param === null || param === void 0 ? void 0 : param.value;
                return {
                    name: inputName,
                    id: `${nodeId}.${inputName}`,
                    schema: {},
            ...
            outputs: diagram.outputNodes().map(outputNode => {
                ...
                const outputName = (0, isStringableParam_1.isStringableParam)(param === null || param === void 0 ? void 0 : param.type) ? (param === null || param === void 0 ? void 0 : param.value).value : param === null || param === void 0 ? void 0 : param.value;
                return {
                    name: outputName,
        ...
        for (const [key, value] of Object.entries(params)) {
            ...
            if (!param)
                throw new Error(`Bad param: ${key}. Param not found on ${node.id}`);
            param.value = (0, isStringableParam_1.isStringableParam)(param.type) ? Object.assign(Object.assign({}, ((_a = param.value) !== null && _a !== void 0 ? _a : {})), { value }) : value;
        }
        if (this.aboveDirective) {
            const aboveNode = this.diagram.nodes.find(node => node.id === this.aboveDirective);
            if (!aboveNode)
    ...
    link(from, to) {
        const link = {
            id: (0, createDataStoryId_1.createDataStoryId)(),
            sourcePortId: from,
            targetPortId: to,
        };
    ...
    linkByLabel(fromLabelDotOutput, toLabelDotInput) {
        ...
        if (!fromNode)
            throw new Error(`Bad from label: ${fromLabelDotOutput}. Node not found`);
        if (!toNode)
            throw new Error(`Bad to label: ${toLabelDotInput}. Node not found`);
        ...
        if (!fromPort)
            throw new Error(`Bad from label: ${fromLabelDotOutput}. Port not found`);
        if (!toPort)
            throw new Error(`Bad to label: ${toLabelDotInput}. Port not found`);
        return this.link(fromPort.id, toPort.id);
    }
    addFake({ label, inputs = [], outputs = [], }) {
        return this.add(Object.assign(Object.assign({}, Fake_1.Fake), { label, inputs: inputs.map((name) => ({ name, schema: { type: 'object' } })), outputs: outputs.map((name) => ({ name, schema: { type: 'object' } })) }));
    }
    withParams(params) {
...
class ComputerFactory {
    getInstance(template) {
        ...
        return Object.assign(Object.assign({}, structuredClone({
            name: (_a = template.name) !== null && _a !== void 0 ? _a : 'unnamed',
            label: (_c = (_b = template.label) !== null && _b !== void 0 ? _b : template.name) !== null && _c !== void 0 ? _c : 'unlabeled',
            category: template.category,
            inputs: (_e = (_d = template.inputs) === null || _d === void 0 ? void 0 : _d.map(portableToPort)) !== null && _e !== void 0 ? _e : [],
            outputs: (_g = (_f = template.outputs) === null || _f === void 0 ? void 0 : _f.map(portableToPort)) !== null && _g !== void 0 ? _g : [],
            params: (_h = template.params) !== null && _h !== void 0 ? _h : [],
        })), { 
            // Methods
            run: (_j = template.run) !== null && _j !== void 0 ? _j : (function () { return __asyncGenerator(this, arguments, function* () { }); }), canRun: template.canRun });
    }
}
...
class Diagram {
    constructor(options) {
        ...
        this.links = (options === null || options === void 0 ? void 0 : options.links) || [];
        this.params = (options === null || options === void 0 ? void 0 : options.params) || [];
        this.viewport = (options === null || options === void 0 ? void 0 : options.viewport) || {
            x: 0,
            y: 0,
            zoom: 1
        };
    ...
    clone() {
        return new Diagram({
            ...
            links: this.links.map(link => (Object.assign({}, link))),
            params: this.params.map(param => (Object.assign({}, param))),
...
class PositionGuesser {
    ...
    guess(node) {
        ...
        const type = (_a = node.type) !== null && _a !== void 0 ? _a : node.name;
        ...
        const baseX = (_b = mostRecentNode === null || mostRecentNode === void 0 ? void 0 : mostRecentNode.position.x) !== null && _b !== void 0 ? _b : maxX;
        return { x: baseX + spaceX, y: (_c = mostRecentNode === null || mostRecentNode === void 0 ? void 0 : mostRecentNode.position.y) !== null && _c !== void 0 ? _c : startY + spaceY };
    }
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.isStringableParam = void 0;
const isStringableParam = (type) => {
    return type === 'StringableParam';
};
exports.isStringableParam = isStringableParam;
...
class DiagramBuilderV3 {
    constructor(computers) {
        ...
        this.nodes = [];
        this.links = [];
        this.computerIdCounters = {};
    }
    add(computerName, config) {
        const template = this.computers.find(e => e.name === computerName);
        // Ensure the computer config exists
        if (!template)
            throw new Error(`Computer config ${computerName} not found`);
        this.addNode(new ComputerFactory_1.ComputerFactory().getInstance(template), config);
        return this;
    }
    connect(connections) {
        if (!connections)
            return this.guessConnections();
        if (typeof connections === 'string')
            return this.connectByString(connections);
        return this.connectByArray(connections);
    }
    connectByArray(connections) {
    ...
    connectByString(connections) {
        const parsed = connections
            ...
            if (!from || !to)
                throw new Error(`Invalid line connection string: \n${connections}\nCould not resolve from & to parts.`);
            if (rest)
                throw new Error(`Invalid line connection string: \n${connections}\nToo many parts.`);
            return [from, to];
        });
    ...
    get() {
        return new Diagram_1.Diagram({
            nodes: this.nodes,
            links: this.links,
        });
    }
    addNode(computer, config) {
        ...
        for (const [key, value] of Object.entries(config)) {
            ...
            if (typeof value === 'object') {
                param = Object.assign(Object.assign({}, param), value);
                continue;
            }
            // Default
            param.value = value;
...
exports.DiagramBuilderV3 = DiagramBuilderV3;
...
exports.ExecutorFactory = {
    create({ diagram, registry, storage, inputObserverController }) {
        ...
        const memory = new ExecutionMemoryFactory_1.ExecutionMemoryFactory(unfolded, registry, storage, inputObserverController).create();
...
class ExecutionMemoryFactory {
    constructor(unfoldedDiagram, registry, storage, inputObserverController) {
        ...
        this.inputObserverController = inputObserverController;
    }
    create() {
        // Create a new memory
        ...
        for (const node of this.unfoldedDiagram.diagram.nodes) {
            ...
            if (!computer)
                throw new Error(`Computer "${node.type}" not found`);
            memory.setNodeRunner(node.id, computer.run({
                input: inputDevice,
                output: outputDevice,
    ...
    makeInputDevice(node, memory) {
        return new InputDevice_1.InputDevice(node, this.unfoldedDiagram, memory, this.inputObserverController);
    }
    ...
    makeParamsDevice(node, memory) {
        return new Proxy({}, {
            get: (_, key) => {
                ...
                try {
                    const emptyItem = {};
                    const evaluator = new ParamEvaluator_1.ParamEvaluator();
                    const globalParams = (_a = this.unfoldedDiagram.unfoldedGlobalParams[node.id]) !== null && _a !== void 0 ? _a : this.unfoldedDiagram.diagram.params;
...
exports.ExecutionMemoryFactory = ExecutionMemoryFactory;
...
class InputDevice {
    ...
    memory, inputObserverController) {
        this.node = node;
        this.unfoldedDiagram = unfoldedDiagram;
        this.memory = memory;
        this.inputObserverController = inputObserverController;
    ...
    pullFrom(name, count = Infinity) {
        ...
        (_a = this.inputObserverController) === null || _a === void 0 ? void 0 : _a.reportItems({
            nodeId: this.node.id,
            portId: name
        }, pulled);
        // Enhance ItemValue to ItemWithParams
        return pulled.map(item => new ItemWithParams_1.ItemWithParams(item, this.node.params, this.globalParamsForNode()));
    }
    pullNew(template = {}) {
        const item = structuredClone(template);
        return [new ItemWithParams_1.ItemWithParams(item, this.node.params, this.globalParamsForNode())];
    }
    getPortNames() {
    ...
    haveItemsAtInput(name, minimum) {
        ...
        for (const link of links) {
            if (this.memory.getLinkItems(link.id).length >= requiredItems)
                return true;
        }
        return false;
    }
    ...
    globalParamsForNode() {
        var _a;
        return (_a = this.unfoldedDiagram.unfoldedGlobalParams[this.node.id]) !== null && _a !== void 0 ? _a : this.unfoldedDiagram.diagram.params;
    }
}
...
class ItemWithParams {
    constructor(value, rawParams, globalParams) {
        ...
        this.params = new Proxy({}, {
            get: (_, key) => {
                ...
                if (!param)
                    throw new Error(`Param "${key}" does not exist`);
                try {
                    const paramEvaluatorInstance = new ParamEvaluator_1.ParamEvaluator();
...
class ParamEvaluator {
    constructor() {
        this.evaluators = [
            new StringableParamEvaluator_1.StringableParamEvaluator(),
            new SelectableParamEvaluator_1.SelectableParamEvaluator(),
            new RepeatableParamEvaluator_1.RepeatableParamEvaluator(this),
        ];
    }
    canEvaluate(param) {
        return this.evaluators.some(e => e.canEvaluate(param));
    }
    evaluate(itemValue, param, globalParams) {
...
exports.ParamEvaluator = ParamEvaluator;
...
const get_1 = __webpack_require__(9);
...
class StringableParamEvaluator {
    ...
    evaluate(itemValue, param, globalParams) {
        ...
        if (param.type !== 'StringableParam')
            throw new Error(`Param "${param.name}" must be StringableParam`);
        let transformedValue = String((_a = param.value) === null || _a === void 0 ? void 0 : _a.value);
        // **********************************************************************
        ...
        if (param.interpolate) {
            ...
            transformedValue = transformedValue.replace(GLOBAL_PARAM_PATTERN, (_, name) => {
                const param = globalParams.find(p => p.name === name);
                if (!param) {
                    console.error(`Global param "${name}" not found`);
                    return '';
                }
                const paramEvaluator = new ParamEvaluator_1.ParamEvaluator();
                return paramEvaluator.evaluate(itemValue, param, []);
            });
        }
        // **********************************************************************
        ...
        if (param.interpolate) {
             ...
             */
            transformedValue = transformedValue.replace(/\${([\w\.]+)}/g, (_, name) => (0, get_1.get)(itemValue, name));
        }
        // **********************************************************************
        // FUNCTIONS
        // **********************************************************************
        ...
        if (true) {
            ...
            transformedValue = transformedValue.replace(/@(\w+)\((.*)\)/g, (_, fn, expression) => {
                const args = expression.split(',').map(arg => arg.trim());
                const functions = {
                    evalMath: (expression) => (0, evalMath_1.evalMath)(expression),
                    env: (expression) => {
                        if (typeof process === 'undefined')
                            throw new Error('env() is not available in the browser');
        ...
        const selectedEvaluation = {
            type: (_b = param.value) === null || _b === void 0 ? void 0 : _b['Evaluation'],
        };
        if ((selectedEvaluation === null || selectedEvaluation === void 0 ? void 0 : selectedEvaluation.type) === 'JSON') {
            transformedValue = JSON.parse(transformedValue);
        }
        if ((selectedEvaluation === null || selectedEvaluation === void 0 ? void 0 : selectedEvaluation.type) === 'HJSON') {
            transformedValue = hjson_1.default.parse(transformedValue);
        }
        if ((selectedEvaluation === null || selectedEvaluation === void 0 ? void 0 : selectedEvaluation.type) === 'JS_FUNCTION') {
            const fn = eval(transformedValue);
            transformedValue = fn(itemValue);
        }
        if ((selectedEvaluation === null || selectedEvaluation === void 0 ? void 0 : selectedEvaluation.type) === 'JS_EXPRESSION') {
            try {
        ...
        // **********************************************************************
        let selectedCast = {
            type: (_c = param.value) === null || _c === void 0 ? void 0 : _c['Cast'],
        };
        if ((selectedCast === null || selectedCast === void 0 ? void 0 : selectedCast.type) === 'stringCast') {
            transformedValue = String(transformedValue);
        }
        if ((selectedCast === null || selectedCast === void 0 ? void 0 : selectedCast.type) === 'numberCast') {
...
exports.StringableParamEvaluator = StringableParamEvaluator;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.RepeatableParamEvaluator = void 0;
class RepeatableParamEvaluator {
    constructor(evaluator) {
        this.evaluator = evaluator;
        this.type = 'RepeatableParam';
    }
    evaluate(itemValue, param, globalParams) {
        return param.value.map((formVal) => {
            const result = Object.fromEntries(param.row.map((row) => {
                const rowParam = Object.assign(Object.assign({}, row), { value: formVal[row.name] });
                return [row.name, this.evaluator.evaluate(itemValue, rowParam, globalParams)];
            }));
            return Object.assign(Object.assign({}, formVal), result);
        });
    }
    canEvaluate(param) {
        return param.type === this.type;
...
exports.RepeatableParamEvaluator = RepeatableParamEvaluator;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.SelectableParamEvaluator = void 0;
class SelectableParamEvaluator {
    constructor() {
        this.type = 'SelectParam';
    }
    evaluate(itemValue, param) {
...
exports.SelectableParamEvaluator = SelectableParamEvaluator;
...
class OutputDevice {
    ...
    pushTo(name, itemable) {
        ...
        for (const linkId of connectedLinks) {
            ...
            this.memory.pushLinkItems(linkId, 
        ...
        return this.diagram.nodes.filter(node => {
            ...
            if (hook)
                return hook({
                    ...
                    params: (0, arrayToRecord_1.arrayToRecord)(node.params, 'name')
                });
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.arrayToRecord = void 0;
const arrayToRecord = (array, key) => {
    const record = {};
...
class UnfoldedDiagramFactory {
    constructor(diagram, nestedNodes) {
        ...
        this.unfoldedGlobalParams = {};
    }
    static create(diagram, nestedNodes) {
    ...
    unfold() {
        ...
        for (const node of replacables) {
            ...
            if (!nestedDiagram)
                throw new Error(`No nesteddiagram found for node type "${node.type}"`);
    ...
    unfoldNode(node) {
        ...
        if (index === -1)
            throw new Error('Node not found in diagram');
        ...
        for (const inputPort of node.inputs) {
            ...
            for (const link of links) {
                const newTargetNode = nestedDiagram.nodes
                    ...
                    const portName = (0, isStringableParam_1.isStringableParam)(param === null || param === void 0 ? void 0 : param.type) ? (param === null || param === void 0 ? void 0 : param.value).value : param === null || param === void 0 ? void 0 : param.value;
                    if (!portName)
                        throw new Error(`No port name found for input node "${node.id}". The node was ${JSON.stringify(node)}`);
                    const matchesPortName = portName === inputPort.name;
                    return matchesPortName;
                });
                if (!newTargetNode)
                    throw new Error(`No input node found for input port "${inputPort.name}" on the nesteddiagram of "${node.type}"`);
                const newInputPort = newTargetNode.inputs[0];
                if (!newInputPort)
                    throw new Error(`No input port found for input port "${inputPort.name}" on the nesteddiagram of "${node.type}". The node was ${JSON.stringify(node)}`);
        ...
        for (const outputPort of node.outputs) {
            ...
            for (const link of links) {
                const newSourceNode = nestedDiagram.nodes
                    ...
                    const portName = (0, isStringableParam_1.isStringableParam)(param === null || param === void 0 ? void 0 : param.type) ? (param === null || param === void 0 ? void 0 : param.value).value : param === null || param === void 0 ? void 0 : param.value;
                    if (!portName)
                        throw new Error(`No port name found for output node "${node.id}. The node was ${JSON.stringify(node)}"`);
                    const matchesPortName = portName === outputPort.name;
                    return matchesPortName;
                });
                if (!newSourceNode)
                    throw new Error(`No output node found for output port "${outputPort.name}" on the nesteddiagram of "${node.type}"`);
                const newOutputPort = newSourceNode.outputs[0];
                if (!newOutputPort)
                    throw new Error(`No output port found for output port "${outputPort.name}" on the nesteddiagram of "${node.type}"`);
                link.sourcePortId = newOutputPort.id;
            }
        }
    }
}
exports.UnfoldedDiagramFactory = UnfoldedDiagramFactory;
        ...
        return {
            ...
            inputs: diagram.nodes
                ...
                const portName = node.params
                    .find(param => param.name === 'port_name').value;
                return {
                    name: portName,
                    schema: {}
                };
...
class Registry {
    constructor(computers, nestedNodes) {
        this.computers = {};
        this.nestedNodes = {};
        this.computers = computers;
        this.nestedNodes = nestedNodes;
...
//# sourceMappingURL=LinkGuesser.js.map
...
const computers = __importStar(__webpack_require__(52));
exports.coreNodeProvider = {
    boot: (app) => {
        app.addComputers(Object.values(computers));
    },
};
//# sourceMappingURL=coreNodeProvider.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.RemoveProperties = exports.Merge = exports.Await = exports.Unique = exports.Sample = exports.Output = exports.Throw = exports.Test = exports.Table = exports.Sleep = exports.Signal = exports.RequestLoopByToken = exports.RequestLoopByOffset = exports.Request = exports.Pass = exports.CreateProperties = exports.Log = exports.Map = exports.Input = exports.InstantThrow = exports.Ignore = exports.FlatMap = exports.Filter = exports.Fake = exports.Clone = exports.Describe = exports.Create = exports.ConsoleLog = exports.Comment = exports.Aggregate = void 0;
...
var Comment_1 = __webpack_require__(62);
Object.defineProperty(exports, "Comment", ({ enumerable: true, get: function () { return Comment_1.Comment; } }));
// export { Concatenate } from './Concatenate';
var ConsoleLog_1 = __webpack_require__(63);
...
var Describe_1 = __webpack_require__(65);
...
var Clone_1 = __webpack_require__(66);
...
var FlatMap_1 = __webpack_require__(68);
Object.defineProperty(exports, "FlatMap", ({ enumerable: true, get: function () { return FlatMap_1.FlatMap; } }));
var Ignore_1 = __webpack_require__(69);
Object.defineProperty(exports, "Ignore", ({ enumerable: true, get: function () { return Ignore_1.Ignore; } }));
var InstantThrow_1 = __webpack_require__(70);
...
var Log_1 = __webpack_require__(74);
Object.defineProperty(exports, "Log", ({ enumerable: true, get: function () { return Log_1.Log; } }));
var CreateProperties_1 = __webpack_require__(75);
Object.defineProperty(exports, "CreateProperties", ({ enumerable: true, get: function () { return CreateProperties_1.CreateProperties; } }));
// export { Merge } from './Merge';
var Pass_1 = __webpack_require__(76);
Object.defineProperty(exports, "Pass", ({ enumerable: true, get: function () { return Pass_1.Pass; } }));
var Request_1 = __webpack_require__(77);
Object.defineProperty(exports, "Request", ({ enumerable: true, get: function () { return Request_1.Request; } }));
var RequestLoopByOffset_1 = __webpack_require__(116);
Object.defineProperty(exports, "RequestLoopByOffset", ({ enumerable: true, get: function () { return RequestLoopByOffset_1.RequestLoopByOffset; } }));
var RequestLoopByToken_1 = __webpack_require__(117);
Object.defineProperty(exports, "RequestLoopByToken", ({ enumerable: true, get: function () { return RequestLoopByToken_1.RequestLoopByToken; } }));
var Signal_1 = __webpack_require__(118);
Object.defineProperty(exports, "Signal", ({ enumerable: true, get: function () { return Signal_1.Signal; } }));
var Sleep_1 = __webpack_require__(119);
Object.defineProperty(exports, "Sleep", ({ enumerable: true, get: function () { return Sleep_1.Sleep; } }));
var Table_1 = __webpack_require__(120);
Object.defineProperty(exports, "Table", ({ enumerable: true, get: function () { return Table_1.Table; } }));
var Test_1 = __webpack_require__(121);
...
var Output_1 = __webpack_require__(124);
...
var RemoveProperties_1 = __webpack_require__(129);
Object.defineProperty(exports, "RemoveProperties", ({ enumerable: true, get: function () { return RemoveProperties_1.RemoveProperties; } }));
//# sourceMappingURL=index.js.map
...
const Param_1 = __webpack_require__(54);
const get_1 = __webpack_require__(9);
exports.Aggregate = {
    name: 'Aggregate',
    label: 'Aggregate',
    ...
    run({ input, output, params }) {
        return __asyncGenerator(this, arguments, function* run_1() {
            ...
            const property = (0, get_1.get)(params, 'aggregation_property');
            console.log({ property });
            const groups = new Map();
            for (const item of all) {
                const key = (0, get_1.get)(item.value, property);
            ...
            for (const [key, group] of groups) {
                const aggretion = {
                    ...
                    key,
                    length: group.length,
                    items: group.map((item) => item.value)
                };
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.hjson = exports.json_ = exports.num = exports.str = exports.createDefaultStringable = void 0;
const numberCast_1 = __webpack_require__(56);
const stringCast_1 = __webpack_require__(57);
const hjsonEvaluation_1 = __webpack_require__(58);
const jsExpressionEvaluation_1 = __webpack_require__(59);
const jsFunctionEvaluation_1 = __webpack_require__(60);
const jsonEvaluation_1 = __webpack_require__(61);
const createDefaultStringable = ({ name, label, help, multiline, canInterpolate, interpolate, evaluations, casts, interpolationsFromPort, value, }) => {
    return {
        name,
...
exports.createDefaultStringable = createDefaultStringable;
const str = ({ name, label, help, multiline, canInterpolate, interpolate, evaluations, value, }) => {
    return {
        name,
        type: 'StringableParam',
        label: label !== null && label !== void 0 ? label : name,
        help: help !== null && help !== void 0 ? help : '',
        multiline: multiline !== null && multiline !== void 0 ? multiline : false,
        canInterpolate: canInterpolate !== null && canInterpolate !== void 0 ? canInterpolate : true,
        interpolate: interpolate !== null && interpolate !== void 0 ? interpolate : true,
        evaluations: evaluations,
        casts: [
            stringCast_1.stringCast
        ],
        value: {
            value: value !== null && value !== void 0 ? value : '',
            Cast: stringCast_1.stringCast.type,
        }
    };
};
exports.str = str;
const num = ({ name, label, help, multiline, canInterpolate, interpolate, evaluations, value, }) => {
    return {
        name,
        type: 'StringableParam',
        label: label !== null && label !== void 0 ? label : name,
        ...
        evaluations: evaluations,
        casts: [
            numberCast_1.numberCast
        ],
        value: {
            value: value !== null && value !== void 0 ? value : 0,
            Cast: numberCast_1.numberCast.type,
        },
    };
};
exports.num = num;
const json_ = ({ name, label, help, multiline = true, canInterpolate, interpolate, evaluations, value, }) => {
    return {
        name,
        type: 'StringableParam',
        label: label !== null && label !== void 0 ? label : name,
        ...
        canInterpolate: canInterpolate !== null && canInterpolate !== void 0 ? canInterpolate : true,
        interpolate: interpolate !== null && interpolate !== void 0 ? interpolate : true,
        evaluations: evaluations !== null && evaluations !== void 0 ? evaluations : [
            jsonEvaluation_1.jsonEvaluation,
            hjsonEvaluation_1.hjsonEvaluation,
            jsFunctionEvaluation_1.jsFunctionEvaluation,
            jsExpressionEvaluation_1.jsExpressionEvaluation,
        ],
        casts: [
            numberCast_1.numberCast,
            stringCast_1.stringCast,
        ...
        value: {
            value: value !== null && value !== void 0 ? value : 0,
            Evaluation: jsonEvaluation_1.jsonEvaluation.type,
        },
    };
};
exports.json_ = json_;
const hjson = ({ name, label, help, multiline = true, canInterpolate, interpolate, evaluations, value, }) => {
    return {
        name,
        type: 'StringableParam',
        label: label !== null && label !== void 0 ? label : name,
        ...
        value: {
            value: value !== null && value !== void 0 ? value : 0,
            Evaluation: hjsonEvaluation_1.hjsonEvaluation.type
        },
    };
};
exports.hjson = hjson;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.numberCast = void 0;
exports.numberCast = {
    type: 'numberCast',
    label: 'Number',
};
//# sourceMappingURL=numberCast.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.stringCast = void 0;
exports.stringCast = {
    type: 'stringCast',
    label: 'String',
};
//# sourceMappingURL=stringCast.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.hjsonEvaluation = void 0;
exports.hjsonEvaluation = {
    type: 'HJSON',
    label: 'HJSON',
};
//# sourceMappingURL=hjsonEvaluation.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.jsExpressionEvaluation = void 0;
exports.jsExpressionEvaluation = {
    type: 'JS_EXPRESSION',
    label: 'JS Expression',
};
//# sourceMappingURL=jsExpressionEvaluation.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.jsFunctionEvaluation = void 0;
exports.jsFunctionEvaluation = {
    type: 'JS_FUNCTION',
    label: 'JS Function',
};
//# sourceMappingURL=jsFunctionEvaluation.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.jsonEvaluation = void 0;
exports.jsonEvaluation = {
    type: 'JSON',
    label: 'JSON',
};
//# sourceMappingURL=jsonEvaluation.js.map
...
exports.Comment = {
    ...
    outputs: [],
    params: [
        (0, Param_1.createDefaultStringable)({
            name: 'content',
            label: 'Content',
...
exports.Create = {
    ...
    params: [
        (0, Param_1.json_)({
            ...
            evaluations: [
                Object.assign(Object.assign({}, hjsonEvaluation_1.hjsonEvaluation), { selected: true }),
                jsonEvaluation_1.jsonEvaluation,
                jsFunctionEvaluation_1.jsFunctionEvaluation,
                jsExpressionEvaluation_1.jsExpressionEvaluation,
            ]
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.truncateDescription = exports.describeCollection = exports.Describe = void 0;
const get_1 = __webpack_require__(9);
const Param_1 = __webpack_require__(54);
exports.Describe = {
    name: 'Describe',
    ...
    run({ input, output, params }) {
        return __asyncGenerator(this, arguments, function* run_1() {
            const incoming = input.pull()
                .map(i => (0, get_1.get)(i.value, String(params.path)));
...
function truncateDescription(description, threshold = 10) {
    const truncate = (obj) => {
        Object.keys(obj).forEach(key => {
            if (typeof obj[key] === 'object' && !Array.isArray(obj[key])) {
                ...
                if (entries.length > threshold) {
                    ...
                    const otherCount = entries.slice(threshold).reduce((acc, [, count]) => acc + count, 0);
                    // Create a new object with the top entries and 'OTHER_VALUES'
                    obj[key] = topEntries.reduce((acc, [value, count]) => {
                        acc[value] = count;
                        return acc;
                    }, {});
        ...
        return __asyncGenerator(this, arguments, function* run_1() {
            while (true) {
                ...
                for (let i = 0; i < count; i++) {
                    output.pushTo('clones', incoming.map(item => (Object.assign(Object.assign({}, item.value), { _clone_id: i }))));
                }
                yield yield __await(void 0);
            }
        });
    ...
    run({ input, output, params }) {
        return __asyncGenerator(this, arguments, function* run_1() {
            while (true) {
                ...
                const portName = (() => {
                    var _a;
                    const portMap = params.port_map;
                    const property = params.property;
                    const value = item.value[property];
                    const mapping = portMap.find((mapping) => mapping.value == value);
                    return (_a = mapping === null || mapping === void 0 ? void 0 : mapping.port) !== null && _a !== void 0 ? _a : 'unfiltered';
                })();
...
//# sourceMappingURL=InstantThrow.js.map
    ...
    run({ input, output }) {
        return __asyncGenerator(this, arguments, function* run_1() {
            while (true) {
                ...
                if (!portName || other.length > 0)
                    throw new Error('Input computer must have exactly one input port.');
...
exports.Map = void 0;
const Param_1 = __webpack_require__(54);
const merge_1 = __webpack_require__(73);
exports.Map = {
    name: 'Map',
    label: 'Map',
    inputs: [{
            ...
            while (true) {
                ...
                const replacers = incoming.map(item => {
                    ...
                    if (params.mode === 'MERGE')
                        return (0, merge_1.merge)(item.value, item.params.json);
...
const merge = (first, second) => {
    ...
    for (const key of Object.keys(second)) {
        if (second[key] instanceof Object)
            Object.assign(second[key], (0, exports.merge)(first[key], second[key]));
    }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.CreateProperties = void 0;
const numberCast_1 = __webpack_require__(56);
const stringCast_1 = __webpack_require__(57);
const hjsonEvaluation_1 = __webpack_require__(58);
const jsFunctionEvaluation_1 = __webpack_require__(60);
        ...
        return __asyncGenerator(this, arguments, function* run_1() {
            while (true) {
                ...
                if (typeof item.value !== 'object')
                    throw new Error('Items sent to CreateProperties must be an objects!');
                const properties = item.params.properties;
                for (const { id, key } of properties) {
                    const fresh = item.params.properties
                        .find((p) => p.id === id);
...
//# sourceMappingURL=CreateProperties.js.map
...
const axios_1 = __importDefault(__webpack_require__(78));
const Param_1 = __webpack_require__(54);
const get_1 = __webpack_require__(9);
exports.Request = {
    name: 'Request',
    ...
    run({ input, output, params }) {
        return __asyncGenerator(this, arguments, function* run_1() {
            while (true) {
                ...
                const { url, method, body, config, item_path } = incoming.params;
                if (method === 'GET') {
                    const response = yield __await(axios_1.default.get(url, config));
                    const items = (0, get_1.get)(response.data, item_path);
...
const FormData$1 = __webpack_require__(79);
const url = __webpack_require__(86);
const proxyFromEnv = __webpack_require__(101);
const http = __webpack_require__(84);
const https = __webpack_require__(85);
const util = __webpack_require__(81);
const followRedirects = __webpack_require__(102);
const zlib = __webpack_require__(114);
const stream = __webpack_require__(82);
const events = __webpack_require__(115);
...
var util = __webpack_require__(81);
var Stream = (__webpack_require__(82).Stream);
var DelayedStream = __webpack_require__(83);
...
module.exports =
{
  parallel      : __webpack_require__(91),
  serial        : __webpack_require__(98),
...
var iterate    = __webpack_require__(92)
  , initState  = __webpack_require__(96)
  , terminator = __webpack_require__(97)
  ;
...
var async = __webpack_require__(93)
  , abort = __webpack_require__(95)
  ;
...
var defer = __webpack_require__(94);
...
var abort = __webpack_require__(95)
  , async = __webpack_require__(93)
  ;
...
var debug = __webpack_require__(104);
...
module.exports = function () {
  if (!debug) {
    try {
      ...
      debug = __webpack_require__(105)("follow-redirects");
    }
    catch (error) { /* */ }
...
function setup(env) {
	...
	createDebug.humanize = __webpack_require__(108);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.RequestLoopByOffset = void 0;
const axios_1 = __importDefault(__webpack_require__(78));
const Param_1 = __webpack_require__(54);
const get_1 = __webpack_require__(9);
exports.RequestLoopByOffset = {
    ...
    run({ input, output, params }) {
        return __asyncGenerator(this, arguments, function* run_1() {
            ...
            const { url, method, body, config, item_path, offset_name, start_offset, limit } = incoming.params;
            ...
            while (hasNextPage) {
                ...
                try {
                    let response;
                    if (method === 'GET') {
                        response = yield __await(axios_1.default.get(currentUrl, config));
                    }
                    else if (method === 'POST') {
                        response = yield __await(axios_1.default.post(currentUrl, body, config));
                    }
                    else {
                    ...
                    yield yield __await(void 0);
                    const nextOffset = items.length == limit ?
...
//# sourceMappingURL=RequestLoopByOffset.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.RequestLoopByToken = void 0;
const axios_1 = __importDefault(__webpack_require__(78));
const Param_1 = __webpack_require__(54);
const get_1 = __webpack_require__(9);
exports.RequestLoopByToken = {
    ...
    run({ input, output, params }) {
        return __asyncGenerator(this, arguments, function* run_1() {
            const [incoming] = input.pullNew();
            const { url, method, body, config, item_path, limit, cursor_token, cursor_path } = incoming.params;
            let hasNextPage = true;
            ...
            while (hasNextPage) {
                ...
                try {
                    ...
                    const items = (0, get_1.get)(response.data, item_path);
                    currentCursor = (0, get_1.get)(response.data, cursor_path);
                    output.pushTo('items', items);
                    output.pushTo('response', [response]);
                    yield yield __await(void 0);
...
//# sourceMappingURL=RequestLoopByToken.js.map
    ...
    run({ input, output, params }) {
        return __asyncGenerator(this, arguments, function* run_1() {
            ...
            while (i <= count) {
                ...
                const shaped = spawned.params.expression;
                output.push([shaped]);
                i++;
                yield yield __await(void 0);
            }
...
exports.Sleep = {
    ...
    params: [
        (0, Param_1.createDefaultStringable)({
            ...
            interpolate: true,
            casts: [
                Object.assign(Object.assign({}, numberCast_1.numberCast), { selected: true })
            ],
            value: String(100)
        }),
    ],
...
exports.Table = {
    ...
    outputs: [],
    params: [],
    run({ input, hooks, params: rawParams, node, storage }) {
        return __asyncGenerator(this, arguments, function* run_1() {
            while (true) {
                const incoming = input.pull();
                storage.itemsMap.set(node.id, (storage.itemsMap.get(node.id) || []).concat(incoming.map(i => i.value)));
                yield yield __await(void 0);
            }
        });
    },
    ...
    run({ input, output, params }) {
        return __asyncGenerator(this, arguments, function* run_1() {
            const evaluateItem = (item) => {
                ...
                const tests = item.params.tests;
                /**
                 * @return {Record<string, (a: string, b: string) => boolean>}
                 * e.g.: { '==': (a, b) => a == b }
                 */
                const operators = sharedOperators.reduce((acc, { value }) => {
                    acc[value] = new Function('a', 'b', `return a ${value} b`);
                    return acc;
                }, {});
            ...
            const segmentByEvaluation = (items) => {
                const failed = [];
                const passed = [];
...
const NodeRunError_1 = __webpack_require__(123);
const numberCast_1 = __webpack_require__(56);
const stringCast_1 = __webpack_require__(57);
const hjsonEvaluation_1 = __webpack_require__(58);
const jsFunctionEvaluation_1 = __webpack_require__(60);
...
//# sourceMappingURL=NodeRunError.js.map
    ...
    run({ input, output }) {
        return __asyncGenerator(this, arguments, function* run_1() {
            while (true) {
                ...
                if (!portName || other.length > 0)
                    throw new Error('Output computer must have exactly one output port.');
                const incoming = input.pull();
...
exports.Await = {
    ...
    canRun({ input, params }) {
        const haveChunk = input.haveItemsAtInput('input', params.number_of_items.value.value);
    ...
    run({ input, output, params }) {
        return __asyncGenerator(this, arguments, function* run_1() {
            ...
            while (true) {
                ...
                if (pulledCount > 0)
                    hasPulledAny = true;
                const chunkSize = params.number_of_items;
                output.push(incoming);
                if (pulledCount === 0)
                    output.pushTo('no_items', [{
                            message: 'No items available to await node.'
                        }]);
                if (pulledCount < chunkSize)
                    break;
                yield yield __await(void 0);
            }
        });
...
exports.Merge = {
    ...
    run({ input, output, params }) {
        return __asyncGenerator(this, arguments, function* run_1() {
            ...
            const requestorKey = params.requestor_key;
            const supplierKey = params.supplier_key;
            const merged = [];
            const notMerged = [];
            for (const requestor of requestors) {
                ...
                if (matchingSupplier) {
                    merged.push(Object.assign(Object.assign({}, requestor.value), matchingSupplier.value));
                }
                else {
...
exports.RemoveProperties = {
    ...
    run({ input, output, params }) {
        ...
        return __asyncGenerator(this, arguments, function* run_1() {
            const items = input.pull();
            const param = ((_a = params.remove_properties) !== null && _a !== void 0 ? _a : []);
            const properties = param.map(p => p.property);
            const result = items.map((item) => {
                const [newItem] = input.pullNew(Object.assign({}, item.value));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.InputObserverController = void 0;
class InputObserverController {
    /**
     * Constructs an instance of InputObserverController
     */
    constructor(inputObservers = [], notifyObservers) {
         ...
         */
        this.isReport = (inputObserver) => {
            return this.inputObservers.filter(({ nodeId, portId }) => {
                if (portId === undefined) {
                    return nodeId === inputObserver.nodeId;
                }
                return (nodeId === inputObserver.nodeId) && (portId === (inputObserver === null || inputObserver === void 0 ? void 0 : inputObserver.portId));
            });
        };
    }
    /**
     ...
     */
    reportItems(inputObserver, items) {
...
exports.InputObserverController = InputObserverController;
...
const coreNodeProvider_1 = __webpack_require__(51);
