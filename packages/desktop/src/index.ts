...
class DataStoryWindow {
  ...
  public getMainWindowActions(): { setTitle: (title: string) => void; webContentsSend: (channel: string, data: any) => void; } {
    return {
      setTitle: (title: string) => this.mainWindow.setTitle(title),
      webContentsSend: (channel: string, data: any) => this.mainWindow.webContents.send(channel, data),
    };
  }
